...
# Функция для покупки продуктов
@dp.message_handler(lambda message: message.text == 'Купить')
async def get_buying_list(message: types.Message):
    products = [
        {"name": "Product1", "description": "Описание продукта 1", "price": 100, "photo": "photo1.png"},
        {"name": "Product2", "description": "Описание продукта 2", "price": 200, "photo": "photo2.png"},
        {"name": "Product3", "description": "Описание продукта 3", "price": 300, "photo": "photo3.png"},
        {"name": "Product4", "description": "Описание продукта 4", "price": 400, "photo": "photo4.png"},
    ]
